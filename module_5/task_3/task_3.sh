...
# Variables
# https://learn.microsoft.com/en-us/azure/container-apps/tutorial-code-to-cloud?tabs=bash%2Ccsharp&pivots=acr-remote
...
rg_name="prokopenko"
acr_name="acr${module_number//-/}${task_number//-/}${RANDOM}"  # Unique ACR name
aca_env_name="aca-${module_number}-${task_number}"
...
az containerapp create \
  ...
  --cpu 0.25 \
  --memory 0.5Gi \
  --env-vars "APP_MESSAGE=${task_number}" \
...
echo "Single endpoint: https://$fqdn"
